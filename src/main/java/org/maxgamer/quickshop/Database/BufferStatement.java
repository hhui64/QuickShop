...
public class BufferStatement {
  ...
  /**
   * Represents a PreparedStatement in a state before preparing it (E.g. No file
   * I/O Required)
   * 
  ...
  /**
   * Returns a prepared statement using the given connection. Will try to return
   * an empty statement if something went wrong. If that fails, returns null.
   * 
   ...
   * information about where the query came from, if something went wrong while
   * executing it.
   * 
  ...
  /**
   * @return A string representation of this statement. Returns <italic>"Query: "
   *         + query + ", values: " + Arrays.toString(values).</italic>
   */
  @Override
