...
public class Database {
  ...
  /**
   * Fetches the connection to this database for querying. Try to avoid doing this
   * in the main thread.
   * 
  ...
  /**
   * Copies the contents of this database into the given database. Does not delete
   * the contents of this database, or change any settings. This may take a long
   * time, and will print out progress reports to System.out
   * 
   * This method does not create the tables in the new database. You need to do
   * that yourself.
   * 
